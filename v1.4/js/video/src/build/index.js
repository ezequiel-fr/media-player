...
export const boxing = (element, addSpace = false) => {
...
export const elementPattern = (element, name, prefix = null) => {
...
export const buttonPattern = (name, innerValues = []) => {
...
export const rangePattern = (name, step = 1, defaultValue = 0) => {
